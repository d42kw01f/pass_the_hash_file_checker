...
# usage
```
usage: ./passthehashes.sh [-h] [-dc-ip DOMAIN IP] [-p PROTOCOL] {mssql,winrm,ssh,ldap,smb} -f [HASH FILE]
-h                        show brief help
-dc-ip                    domain ip
-p                        protocol that is testing (crackmapexec protocols)
-f                        file that includes hashes with usernames
```
